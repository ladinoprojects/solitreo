...
The proof files, QA tests, and font files are also available automatically for each commit to the main branch of this Git repository via GitHub Actions - look at https://github.com/ladinoprojects/solitreo/actions
